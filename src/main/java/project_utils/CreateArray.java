...
public class CreateArray {
    ...
    //В голубой папке java создать класс project_utils.CreateArray,
    ...
    public String[] createStringArray(String a, String b, String c, String d, String e) {
        ...
        //Написать метод createArrayFromText(), который принимает на
        // вход предложение из нескольких слов и возвращает массив из этих слов.
        //Например, createArrayFromText(“It was an apple pie”)
        // -> {“It”, “was”, “an”, “apple”, “pie”}

        public String[] createArrayFromText (@NotNull String sentence){
